...
export const ResumeLayoutRoutes: Routes = [
  ...
  { path: 'resume/girone-detail/:letter', component: GironeDetailComponent },
  { path: 'resume/club-detail/:id', component: ClubDetailComponent },
  { path: 'resume/player-detail/:id', component: PlayerDetailComponent },
]